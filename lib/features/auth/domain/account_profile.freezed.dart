...
mixin _$AccountProfile {
 ...
 String get id; String get fullName; String get email; String get phone; AccountRole get role; String get language; bool get isActive;
...
@override
int get hashCode => Object.hash(runtimeType,id,fullName,email,phone,role,language,isActive);

@override
String toString() {
  return 'AccountProfile(id: $id, fullName: $fullName, email: $email, phone: $phone, role: $role, language: $language, isActive: $isActive)';
}
...
@useResult
$Res call({
 String id, String fullName, String email, String phone, AccountRole role, String language, bool isActive
});
...
/// Create a copy of AccountProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = null,Object? email = null,Object? phone = null,Object? role = null,Object? language = null,Object? isActive = null,}) {
...
as AccountRole,language: null == language ? _self.language : language // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fullName,  String email,  String phone,  AccountRole role,  String language,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountProfile() when $default != null:
return $default(_that.id,_that.fullName,_that.email,_that.phone,_that.role,_that.language,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fullName,  String email,  String phone,  AccountRole role,  String language,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _AccountProfile():
return $default(_that.id,_that.fullName,_that.email,_that.phone,_that.role,_that.language,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fullName,  String email,  String phone,  AccountRole role,  String language,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _AccountProfile() when $default != null:
return $default(_that.id,_that.fullName,_that.email,_that.phone,_that.role,_that.language,_that.isActive);case _:
  return null;
...
class _AccountProfile extends AccountProfile {
  const _AccountProfile({required this.id, required this.fullName, required this.email, required this.phone, required this.role, required this.language, required this.isActive}): super._();
...
/// Create a copy of AccountProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fullName = null,Object? email = null,Object? phone = null,Object? role = null,Object? language = null,Object? isActive = null,}) {
